...
namespace ply {
  namespace callback_types {
    ...
    template<> struct callbacks_element<boost::mpl::_2>;

    class list_property_definition_callbacks_type
    {
    private:
      typedef boost::mpl::inherit_linearly<
        callback_types::sequence_product<callback_types::size_types, callback_types::scalar_types>::type,
        boost::mpl::inherit<
          boost::mpl::_1,
          callback_types::callbacks_element<boost::mpl::_2>
        >
      >::type callbacks;
      callbacks callbacks_;
    public:
      template <typename SizeType, typename ScalarType>
      typename callback_types::list_property_definition_callback_type<SizeType, ScalarType>::type& get()
      {
        return static_cast<callback_types::callbacks_element<boost::mpl::pair<SizeType, ScalarType> >&>(callbacks_).callback;
      }
      template <typename SizeType, typename ScalarType>
      const typename callback_types::list_property_definition_callback_type<SizeType, ScalarType>::type& get() const
      {
...
public:
  ...
  void scalar_property_definition_callbacks(const callback_types::scalar_property_definition_callbacks_type& scalar_property_definition_callbacks);
  void list_property_definition_callbacks(const callback_types::list_property_definition_callbacks_type& list_property_definition_callbacks);
...
private:
  ...
  struct scalar_property : public property
  {
    ...
    typedef typename callback_types::scalar_property_callback_type<scalar_type>::type callback_type;
  ...
  struct list_property : public property
  {
    ...
    typedef ScalarType scalar_type;
    typedef typename callback_types::list_property_begin_callback_type<size_type, scalar_type>::type begin_callback_type;
    typedef typename callback_types::list_property_element_callback_type<size_type, scalar_type>::type element_callback_type;
    typedef typename callback_types::list_property_end_callback_type<size_type, scalar_type>::type end_callback_type;
  ...
  callback_types::scalar_property_definition_callbacks_type scalar_property_definition_callbacks_;
  callback_types::list_property_definition_callbacks_type list_property_definition_callbacks_;
  ...
  template <typename ScalarType> bool parse_scalar_property(format_type format, std::istream& istream, const typename callback_types::scalar_property_callback_type<ScalarType>::type& scalar_property_callback);
  template <typename SizeType, typename ScalarType> bool parse_list_property(format_type format, std::istream& istream, const typename callback_types::list_property_begin_callback_type<SizeType, ScalarType>::type& list_property_begin_callback, const typename callback_types::list_property_element_callback_type<SizeType, ScalarType>::type& list_property_element_callback, const typename callback_types::list_property_end_callback_type<SizeType, ScalarType>::type& list_property_end_callback);
...
inline void ply::ply_parser::scalar_property_definition_callbacks(const callback_types::scalar_property_definition_callbacks_type& scalar_property_definition_callbacks)
{
  scalar_property_definition_callbacks_ = scalar_property_definition_callbacks;
}

inline void ply::ply_parser::list_property_definition_callbacks(const callback_types::list_property_definition_callbacks_type& list_property_definition_callbacks)
{
...
{
  typedef ScalarType scalar_type;
  typename callback_types::scalar_property_definition_callback_type<scalar_type>::type& scalar_property_definition_callback = scalar_property_definition_callbacks_.get<scalar_type>();
  typename callback_types::scalar_property_callback_type<scalar_type>::type scalar_property_callback;
...
inline void ply::ply_parser::parse_list_property_definition(const std::string& property_name)
{
  typedef SizeType size_type;
  typedef ScalarType scalar_type;
  typename callback_types::list_property_definition_callback_type<size_type, scalar_type>::type& list_property_definition_callback = list_property_definition_callbacks_.get<size_type, scalar_type>();
  typedef typename callback_types::list_property_begin_callback_type<size_type, scalar_type>::type list_property_begin_callback_type;
  typedef typename callback_types::list_property_element_callback_type<size_type, scalar_type>::type list_property_element_callback_type;
  typedef typename callback_types::list_property_end_callback_type<size_type, scalar_type>::type list_property_end_callback_type;
...
template <typename ScalarType>
inline bool ply::ply_parser::parse_scalar_property(format_type format, std::istream& istream, const typename callback_types::scalar_property_callback_type<ScalarType>::type& scalar_property_callback)
{
